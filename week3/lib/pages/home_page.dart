    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor:
            lightOrange, // Set the background color to light orange
  ...
  void addItemToFirebase(String name, double price) {
    ...
    if (uid != null) {
      ...
      FirebaseFirestore.instance
        ...
        // Data added successfully, update the _categoryValues map
        setState(() {
                ...
                children: [
                  if (_showCategories)
                    ..._categoryValues.entries
                        .map((entry) => CategoryItem(entry.key, entry.value))
                        .toList(),
                ],
              ),
            ),
